...
- (void)viewDidLoad {
    [super viewDidLoad];
    DJLMarqueeView* marqueeView = [[DJLMarqueeView alloc] initWithFrame:CGRectMake(0, 20, self.view.frame.size.width, 30)];
    marqueeView.dataSource = @[@"跑马灯1",@"跑马灯2",@"跑马灯3"];
    marqueeView.replace = DJLMarqueeReplaceTypeReplaceAll;
    marqueeView.delegate = self;
    [self.view addSubview:marqueeView];
    [marqueeView starMarQuee];
}
